...
{
    public static class VerifyDatabaseAccessorTask
    {
        public static bool Execute(string projectDirectory, string @namespace, IEnumerable<string> assemblyReferences, IEnumerable<string> inputs, TaskLoggingHelper logger)
        {
