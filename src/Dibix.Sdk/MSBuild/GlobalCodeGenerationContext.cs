...
namespace Dibix.Sdk.MSBuild
{
    internal sealed class GlobalCodeGenerationContext : ICodeGenerationContext
    {
        ...
        public GlobalCodeGenerationContext(string projectDirectory, IEnumerable<string> inputs, IAssemblyLocator assemblyLocator, IErrorReporter errorReporter)
        {
