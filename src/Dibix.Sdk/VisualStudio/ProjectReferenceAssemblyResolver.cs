...
{
    internal sealed class ProjectReferenceAssemblyResolver : AssemblyResolver
    {
        #region Fields
        ...
        #region Overrides
        protected override bool TryGetAssemblyLocation(string assemblyName, out string assemblyPath)
        {
