...
namespace Dibix.Sdk.CodeGeneration
{
    internal abstract class ContractClassWriter : ArtifactWriterBase
    {
        ...
        protected virtual IEnumerable<SchemaDefinition> CollectContracts(CodeGenerationContext context) => context.Model.Contracts.Concat(CollectAutoGeneratedContracts(context));
        #endregion
