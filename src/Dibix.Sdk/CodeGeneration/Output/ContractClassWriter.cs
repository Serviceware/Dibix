...
namespace Dibix.Sdk.CodeGeneration
{
    internal abstract class ContractClassWriter : ArtifactWriterBase
    {
        ...
        {
            var namespaceGroups = CollectContracts(context).GroupBy(x => context.GetRelativeNamespace(this.LayerName, x.Namespace)).ToArray();
        ...
        private static IEnumerable<SchemaDefinition> CollectContracts(CodeGenerationContext context) => context.Model.Contracts.Union(CollectAutoGeneratedContracts(context));
