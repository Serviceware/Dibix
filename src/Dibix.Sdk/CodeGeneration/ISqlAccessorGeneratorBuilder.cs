...
namespace Dibix.Sdk.CodeGeneration
{
    public interface ISqlAccessorGeneratorBuilder
    {
        ...
        ISqlAccessorGeneratorBuilder SelectOutputWriter<TWriter>() where TWriter : IWriter;
        ISqlAccessorGeneratorBuilder SelectOutputWriter<TWriter>(Action<IOutputConfigurationExpression> configuration) where TWriter : IWriter;
        string Generate();
    }
}