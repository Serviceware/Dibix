...
namespace Dibix.Sdk.CodeGeneration
{
    public sealed class ObjectSchemaProperty
    {
        ...
        public ObjectSchemaProperty(string name, TypeReference type = default, bool isPartOfKey = default, bool isOptional = default, bool isDiscriminator = default, ValueReference defaultValue = default, SerializationBehavior serializationBehavior = default, DateTimeKind dateTimeKind = default, bool obfuscated = default)
        {
            this.Name = name;
            this.Type = type;
