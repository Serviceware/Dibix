...
namespace Dibix.Sdk.CodeGeneration
{
    internal static class CodeGenerationModelLoader
    {
        ...
        )
        {
            ...
            IContractDefinitionProvider contractDefinitionProvider = new ContractDefinitionProvider(artifactGenerationConfiguration, fileSystemProvider, typeResolver, schemaDefinitionResolver, logger);
