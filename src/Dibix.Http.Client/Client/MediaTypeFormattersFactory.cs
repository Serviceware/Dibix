...
namespace Dibix.Http.Client
{
    public static class MediaTypeFormattersFactory
    {
        public static MediaTypeFormatterCollection Create(HttpClientOptions options, HttpClient client)
        {
            ...
            jsonMediaTypeFormatter.SerializerSettings.ContractResolver = new HttpClientJsonContractResolver(client.BaseAddress.Authority, jsonMediaTypeFormatter, options.ResponseContent.MakeRelativeUrisAbsolute);
