    ...
    internal sealed class BuiltInSchemaProvider : ISchemaProvider
    {
        ...
        private static ObjectSchema CollectProblemDetailsSchema()
        {
            ...
            [
              ...
              , new ObjectSchemaProperty(name: new Token<string>("Detail", SourceLocation), new PrimitiveTypeReference(PrimitiveType.String, isNullable: false, isEnumerable: false), isOptional: false/*, maxLength: 4096, description: "A human-readable explanation specific to this occurrence of the problem."*/)
