...
namespace Dibix.Sdk.CodeGeneration
{
    public sealed class AccessorCodeGenerator : CodeGenerator
    {
        ...
        protected override IEnumerable<ArtifactWriterBase> SelectWriters(CodeGenerationModel model)
        {
            ...
            yield return new ApiDescriptionWriter(assumeEmbeddedActionTargets: false, includeReflectionTargets: true, includeTargetsWithRefParameters: true, includeTargetsWithBodyConverter: true, generateActionDelegates: false);
