    ...
    public sealed class SqlStoredProcedureVisitor : SqlParserVisitor
    {
        ...
        public override void ExplicitVisit(CreateProcedureStatement node)
        {
            ...
            if (fileResultElement != null && fileResultElement.TryGetPropertyValue(SqlFileResultMarkupProperty.Json, isDefault: true, out Token<string> jsonFileResult) && jsonFileResult == SqlFileResultMarkupProperty.Json)
                definition.IsJsonFileResult = jsonFileResult.Location;
        ...
        private TypeReference GenerateGridResultType(SqlStatementDefinition definition, string relativeNamespace, ISqlMarkupDeclaration markup)
        {
            ...
            IList<ObjectSchemaProperty> properties = definition.Results
                                                               ...
                                                               .ToArray();
            ObjectSchema schema = new ObjectSchema(targetPath.AbsoluteNamespace, targetPath.RelativeNamespace, targetPath.TargetName, SchemaDefinitionSource.AutoGenerated, location, properties, isJsonFileResult: definition.IsJsonFileResult);
        ...
        private void CollectResultType(SqlStatementDefinition definition, string relativeNamespace, ISqlMarkupDeclaration markup)
        {
            ...
            ValidateJsonFileResult(definition);
        }
        ...
        private void ValidateJsonFileResult(SqlStatementDefinition definition)
        {
            if (definition.IsJsonFileResult == null)
                return;
