...
namespace Dibix.Sdk.CodeGeneration
{
    internal sealed class EnumContractVisitor : TSqlFragmentVisitor
    {
        ...
        private EnumSchema CollectEnumSchema(CreateTableStatement createTableStatement, Token<string> enumContractName, string relativeNamespace)
        {
            ...
            {
                if (TryCollectEnumSchema(enumContractName, relativeNamespace, checkConstraint.CheckCondition.SkipParenthesis(), out EnumSchema enumSchema))
                    return enumSchema;
            }
            ...
            switch (checkCondition)
            {
              ...
              OR ([id]=(104) AND [name] = N'Feature4'
                ...
                */
                ...
                // [id]=(101)
                case BooleanComparisonExpression booleanComparisonExpression when TryCollectSchemaMembers(schema, booleanComparisonExpression, nameComparisonExpression: null):
                    break;
        ...
        private static bool TryCollectSchemaMembers(EnumSchema schema, BooleanComparisonExpression flagComparisonExpression, BooleanComparisonExpression nameComparisonExpression)
        {
            // [id]
            if (flagComparisonExpression.FirstExpression is not ColumnReferenceExpression)
                return false;
        ...
        private static bool TryCollectSchemaMembers(EnumSchema schema, BooleanBinaryExpression booleanBinaryExpression)
        {
            ...
            return records.Any() && records.All(x => TryCollectSchemaMembers(schema, x.FlagComparison, x.NameComparison));
        }
