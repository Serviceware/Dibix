namespace Dibix.Sdk.Cli
{
    internal sealed class SetOfficialNuGetPackageFeedApiKeyCommand : SetEnvironmentVariableCommand
    {
        ...
        public SetOfficialNuGetPackageFeedApiKeyCommand() : base("official-nuget-feed-api-key", "Set the API key to be used when unlisting packages from the official NuGet package feed.", "The API key.", isSecret: true)
        {
        }
    }
}