namespace Dibix.Sdk.Cli
{
    internal sealed class SetAlternateNuGetPackageFeedApiKeyCommand : SetEnvironmentVariableCommand
    {
        ...
        public SetAlternateNuGetPackageFeedApiKeyCommand() : base("alternate-nuget-feed-api-key", "Set the API key to be used when pushing to the alternate NuGet package feed.", "The API key.")
        {
        }
    }
}