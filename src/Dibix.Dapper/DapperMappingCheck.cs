...
namespace Dibix.Dapper
{
    internal abstract class DapperMappingCheck
    {
        ...
        internal void Check<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>() => this.Check(typeof(TFirst), typeof(TSecond), typeof(TThird), typeof(TFourth), typeof(TFifth), typeof(TSixth));
        internal void Check<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh>() => this.Check(typeof(TFirst), typeof(TSecond), typeof(TThird), typeof(TFourth), typeof(TFifth), typeof(TSixth), typeof(TSeventh));
