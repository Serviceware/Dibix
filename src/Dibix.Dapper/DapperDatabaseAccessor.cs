...
namespace Dibix.Dapper
{
    public sealed class DapperDatabaseAccessor : DatabaseAccessor, IDatabaseAccessor, IDisposable
    {
        ...
        private DapperDatabaseAccessor(DbConnection connection, DapperMappingBehavior mappingBehavior, Action onDispose) : base(connection, onDispose)
        {
        ...
        {
            return base.Connection.Execute(sql, parameters.AsDapperParams(), commandType: commandType);
        }

        public override Task<int> ExecuteAsync(string sql, CommandType commandType, IParametersVisitor parameters)
        {
            return base.Connection.ExecuteAsync(sql, parameters.AsDapperParams(), commandType: commandType);
        }
        ...
        protected override IEnumerable<T> QueryMany<T>(string sql, CommandType commandType, IParametersVisitor parameters)
        {
            ...
            return base.Connection.Query<T>(sql, parameters.AsDapperParams(), commandType: commandType);
        }
        ...
        protected override IEnumerable<TReturn> QueryMany<TFirst, TSecond, TReturn>(string sql, CommandType commandType, IParametersVisitor parameters, Func<TFirst, TSecond, TReturn> map, string splitOn)
        {
            ...
            return base.Connection.Query(sql, map, parameters.AsDapperParams(), commandType: commandType, splitOn: splitOn);
        }
        ...
        {
            SqlMapper.GridReader reader = base.Connection.QueryMultiple(sql, parameters.AsDapperParams(), commandType: commandType);
