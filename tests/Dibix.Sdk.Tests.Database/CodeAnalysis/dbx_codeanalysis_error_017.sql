...
AS
	...
	(
	  ...
	  , INDEX [IX_dbx_codeanalysis_error_017_success_success1] NONCLUSTERED ([id])
	  , INDEX [IX_dbx_codeanalysis_error_017_successx_fail1] NONCLUSTERED ([id])

	  , INDEX [UQ_dbx_codeanalysis_error_017_success_success1] UNIQUE NONCLUSTERED ([id])
	  , INDEX [UQ_dbx_codeanalysis_error_017_successx_fail1] UNIQUE NONCLUSTERED ([id])
	)
	...
	CREATE NONCLUSTERED INDEX [IX_dbx_codeanalysis_error_017_success_success2] ON [dbo].[dbx_codeanalysis_error_017_success] ([id])
	CREATE NONCLUSTERED INDEX [IX_dbx_codeanalysis_error_017_successx_fail2] ON [dbo].[dbx_codeanalysis_error_017_success] ([id])

	CREATE UNIQUE NONCLUSTERED INDEX [UQ_dbx_codeanalysis_error_017_success_success2] ON [dbo].[dbx_codeanalysis_error_017_success] ([id])
	CREATE UNIQUE NONCLUSTERED INDEX [UQ_dbx_codeanalysis_error_017_successx_fail2] ON [dbo].[dbx_codeanalysis_error_017_success] ([id])