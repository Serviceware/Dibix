...
--, CONSTRAINT [FK_dbx_codeanalysis_error_017_fail_idx] FOREIGN KEY ([id]) REFERENCES [dbo].[dbx_table] ([id])
  , CONSTRAINT [FK_dbx_codeanalysis_error_017_fail_id_] FOREIGN KEY ([id]) REFERENCES [dbo].[dbx_table] ([id])
  , CONSTRAINT [CK_dbx_codeanalysis_error_017_fail_abc_] CHECK ([id] > 0)
--, CONSTRAINT [UQ_dbx_codeanalysis_error_017_fail_idx] UNIQUE ([id])
  , CONSTRAINT [UQ_dbx_codeanalysis_error_017_fail_id_] UNIQUE ([id])
)