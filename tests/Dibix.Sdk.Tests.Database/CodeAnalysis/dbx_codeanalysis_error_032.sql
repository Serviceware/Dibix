CREATE TABLE [dbo].[dbx_codeanalysis_error_032_table_fail1]
(
  ...
  , CONSTRAINT [PK_dbx_codeanalysis_error_032_table_fail1] PRIMARY KEY ([a], [b], [c], [d], [e], [f], [g], [h], [i], [j], [k], [l], [m], [n], [o])
)
GO
CREATE TABLE [dbo].[dbx_codeanalysis_error_032_table_fail2]
(
  ...
  , CONSTRAINT [PK_dbx_codeanalysis_error_032_table_fail2] PRIMARY KEY ([r], [s], [t], [u], [v], [w], [x], [y], [z], [aa])
  , CONSTRAINT [UQ_dbx_codeanalysis_error_032_table_fail2_ab] UNIQUE ([ab])
  , INDEX [IX_dbx_codeanalysis_error_032_table_fail2_ac] ([ac])
)
GO
CREATE TABLE [dbo].[dbx_codeanalysis_error_032_table_success1]
(
	[a] BIT            NOT NULL -- 1   byte
  , [b] TINYINT        NOT NULL -- 1   byte
  , [c] SMALLINT       NOT NULL -- 2   bytes
  ...
  , CONSTRAINT [PK_dbx_codeanalysis_error_032_table_success1] PRIMARY KEY ([a], [b], [c], [d], [e], [f], [g], [h], [i], [j], [k], [l], [m], [n], [o])
)
GO
CREATE TABLE [dbo].[dbx_codeanalysis_error_032_table_success2]
(
    [r]  VARCHAR          NOT NULL -- 1   byte    Default: VARCHAR(1)
  , [s]  VARCHAR(128)     NOT NULL -- 128 bytes	  
  , [t]  NVARCHAR         NOT NULL -- 2   bytes   Default: NVARCHAR(1)
  ...
  , CONSTRAINT [PK_dbx_codeanalysis_error_032_table_success2] PRIMARY KEY ([r], [s], [t], [u], [v], [w], [x], [y], [z], [aa])
  , CONSTRAINT [UQ_dbx_codeanalysis_error_032_table_success2_ab] UNIQUE ([ab])
  , INDEX [IX_dbx_codeanalysis_error_032_table_success2_ac] ([ac])
)
GO
CREATE TYPE [dbo].[dbx_codeanalysis_error_032_type_fail1] AS TABLE
(
	[a] BIT            NOT NULL -- 1   byte
  , [b] TINYINT        NOT NULL -- 1   byte
  , [c] SMALLINT       NOT NULL -- 2   bytes
...
GO
CREATE TYPE [dbo].[dbx_codeanalysis_error_032_type_fail2] AS TABLE
(
    [r]  VARCHAR          NOT NULL -- 1   byte    Default: VARCHAR(1)
  , [s]  VARCHAR(128)     NOT NULL -- 128 bytes	  
  , [t]  NVARCHAR         NOT NULL -- 2   bytes   Default: NVARCHAR(1)
  ...
  , [ab] VARBINARY(1701)  NOT NULL
  , [ac] VARBINARY(1701)  NOT NULL
  , PRIMARY KEY ([r], [s], [t], [u], [v], [w], [x], [y], [z], [aa])
)
GO
CREATE TYPE [dbo].[dbx_codeanalysis_error_032_type_success1] AS TABLE
(
	[a] BIT            NOT NULL -- 1   byte
  , [b] TINYINT        NOT NULL -- 1   byte
  , [c] SMALLINT       NOT NULL -- 2   bytes
...
GO
CREATE TYPE [dbo].[dbx_codeanalysis_error_032_type_success2] AS TABLE
(
    [r]  VARCHAR          NOT NULL -- 1   byte    Default: VARCHAR(1)
  , [s]  VARCHAR(128)     NOT NULL -- 128 bytes	  
  , [t]  NVARCHAR         NOT NULL -- 2   bytes   Default: NVARCHAR(1)
