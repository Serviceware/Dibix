-- @Namespace Grid
-- @Name GetGrid
-- @Return ClrTypes:Extension.MultiMapContract;GenericContract;Direction SplitOn:id,direction Mode:SingleOrDefault
-- @Return ClrTypes:Direction Name:Directions
-- @MergeGridResult
CREATE PROCEDURE [dbo].[dbx_tests_syntax_gridresult_merge] @result BIT OUTPUT
AS
BEGIN
	SET @result = NULL
