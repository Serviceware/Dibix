...
namespace Dibix.Sdk.Tests.Data
{
    ...
    public static class TestAccessor
    {
        ...
        public static IEnumerable<Dibix.Sdk.Tests.DomainModel.GenericContract> MultiConcreteResult(this IDatabaseAccessorFactory databaseAccessorFactory, Action<DatabaseAccessorOptions> configure = null)
        {
            ...
            IEnumerable<Dibix.Sdk.Tests.DomainModel.GenericContract> result = accessor.QueryMany<Dibix.Sdk.Tests.DomainModel.GenericContract>(MultiConcreteResultCommandText, CommandType.Text, ParametersVisitor.Empty);
            return result;
        }
    }
}
