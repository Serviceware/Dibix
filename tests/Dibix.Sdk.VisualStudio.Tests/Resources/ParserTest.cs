...
#region Accessor
namespace Dibix.Sdk.VisualStudio.Tests.Data
{
    [DatabaseAccessor]
...
(SELECT 2);";
        ...
        public static dbx_tests_parser_invalidcolumnsforentityResult dbx_tests_parser_invalidcolumnsforentity(this IDatabaseAccessorFactory databaseAccessorFactory)
        {
            ...
            {
                using (IMultipleResultReader reader = accessor.QueryMultiple(dbx_tests_parser_invalidcolumnsforentityCommandText, CommandType.Text, ParametersVisitor.Empty))
                {
        ...
        public static dbx_tests_parser_nestedifsResult dbx_tests_parser_nestedifs(this IDatabaseAccessorFactory databaseAccessorFactory)
        {
            using (IDatabaseAccessor accessor = databaseAccessorFactory.Create())
            {
                using (IMultipleResultReader reader = accessor.QueryMultiple(dbx_tests_parser_nestedifsCommandText, CommandType.Text, ParametersVisitor.Empty))
                {
                    dbx_tests_parser_nestedifsResult result = new dbx_tests_parser_nestedifsResult();
                    result.A.ReplaceWith(reader.ReadMany<int>());
                    result.B.ReplaceWith(reader.ReadMany<int>());
                    result.C.ReplaceWith(reader.ReadMany<int>());
                    result.D.ReplaceWith(reader.ReadMany<int>());
                    result.E.ReplaceWith(reader.ReadMany<int>());
                    return result;
                }
            }
        }

        public static dbx_tests_parser_nobeginendResult dbx_tests_parser_nobeginend(this IDatabaseAccessorFactory databaseAccessorFactory, Dibix.Sdk.VisualStudio.Tests.Direction? param1 = null)
        {
            using (IDatabaseAccessor accessor = databaseAccessorFactory.Create())
            {
                ParametersVisitor @params = accessor.Parameters()
                                                    ...
                                                    .Build();
                using (IMultipleResultReader reader = accessor.QueryMultiple(dbx_tests_parser_nobeginendCommandText, CommandType.Text, @params))
                {
        ...
        public static dbx_tests_parser_typenamesResult dbx_tests_parser_typenames(this IDatabaseAccessorFactory databaseAccessorFactory)
        {
            using (IDatabaseAccessor accessor = databaseAccessorFactory.Create())
            {
                using (IMultipleResultReader reader = accessor.QueryMultiple(dbx_tests_parser_typenamesCommandText, CommandType.Text, ParametersVisitor.Empty))
                {
        ...
        public static IEnumerable<int> dbx_tests_parser_unionreturn(this IDatabaseAccessorFactory databaseAccessorFactory)
        {
            using (IDatabaseAccessor accessor = databaseAccessorFactory.Create())
            {
                return accessor.QueryMany<int>(dbx_tests_parser_unionreturnCommandText, CommandType.Text, ParametersVisitor.Empty);
            }
        }
        ...
        public static void dbx_tests_parser_xmlparam(this IDatabaseAccessorFactory databaseAccessorFactory, System.Xml.Linq.XElement x)
        {
            using (IDatabaseAccessor accessor = databaseAccessorFactory.Create())
            {
                ParametersVisitor @params = accessor.Parameters()
                                                    ...
                                                    .Build();
                accessor.Execute(dbx_tests_parser_xmlparamCommandText, CommandType.Text, @params);
            }
        }
    }
}
...
#region Contracts
namespace Dibix.Sdk.VisualStudio.Tests.DomainModel
{
    internal sealed class dbx_tests_parser_invalidcolumnsforentityResult
    {
        public IList<int?> A { get; private set; }
        public IList<int> B { get; private set; }
        public IList<string> C { get; private set; }
        public IList<Dibix.Sdk.VisualStudio.Tests.Direction?> D { get; private set; }
        public IList<Dibix.Sdk.VisualStudio.Tests.SpecialEntity> E { get; private set; }
    ...
    internal sealed class dbx_tests_parser_nestedifsResult
    {
        public IList<int> A { get; private set; }
        public IList<int> B { get; private set; }
        public IList<int> C { get; private set; }
        public IList<int> D { get; private set; }
        public IList<int> E { get; private set; }
        ...
        public dbx_tests_parser_nestedifsResult()
        {
            ...
            this.D = new Collection<int>();
            this.E = new Collection<int>();
        }
    }
    ...
    {
        public IList<string> A { get; private set; }
        public IList<int?> B { get; private set; }
        public IList<Dibix.Sdk.VisualStudio.Tests.Direction> C { get; private set; }
        public IList<Dibix.Sdk.VisualStudio.Tests.Direction?> D { get; private set; }
        public IList<Dibix.Sdk.VisualStudio.Tests.Direction> E { get; private set; }
        public IList<Dibix.Sdk.VisualStudio.Tests.Direction?> F { get; private set; }
        public IList<string> G { get; private set; }
        public IList<Dibix.Sdk.VisualStudio.Tests.Direction?> H { get; private set; }
