...
{
    public partial class TextTemplateCodeGeneratorTests : TestBase
    {
        ...
        private string ExecuteTest(Action<ICodeGeneratorConfigurationExpression> configure)
        {
            ...
            string templateFile = Path.GetFullPath(Path.Combine(projectDirectory, $"{base.TestContext.TestName}.tt"));
        ...
        private void Assert(string generated) => this.Assert(base.TestContext.TestName, generated);
        private void Assert(string expectedTextKey, string generated)
        {
            ...
            base.AssertEqual(expectedText, actualText, extension);
        }
    }
}